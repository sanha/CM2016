 ...
 * $Id: myping.cc,v 1.8 2005/08/25 18:58:01 johnh Exp $
 *
...
// $Header: /cvsroot/nsnam/ns-2/apps/myping.cc,v 1.8 2005/08/25 18:58:01 johnh Exp $
...
public:
	MyPingHeaderClass() : PacketHeaderClass("PacketHeader/Ping", 
					      sizeof(hdr_myping)) {
...
MyPingAgent::MyPingAgent() : Agent(PT_MYPING), seq(0), oneway(0)
{
...
int MyPingAgent::command(int argc, const char*const* argv)
{
  if (argc == 2) {
    if (strcmp(argv[1], "send") == 0) {
      ...
      hdr_myping* ph = hdr_myping::access(pkt);
