...
#Define a 'recv' function for the class 'Agent/NewPing'
Agent/NewPing instproc recv {from rtt} {
    $self instvar node_
...
#Create NewPing agent and attach it to node 1 and 5
set newping0 [new Agent/NewPing]
$ns attach-agent $n1 $newping0
set newping1 [new Agent/NewPing]
$ns attach-agent $n5 $newping1
...
$ns connect $newping0 $newping1

#Start logging the received bandwith
$ns at 0.0 "record"

#Schedule events for the agents
$ns at 1.0 "$newping0 send"
$ns at 10.0 "$cbr0 start"
$ns at 11.0 "$newping0 send"
